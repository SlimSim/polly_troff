  ...
  Polymer('my-slider', {
    ...
    /**
     * The nr of degrees that the slider is rotated clockwise.
     *
     * @attribute rotated
     * @type number [deg]
     * @default 0
    ...
    track: function(e) {
      ...
      var deg = Math.PI * this.rotated / 180;
      var d = Math.cos(deg) * e.dx + Math.sin(deg) * e.dy;
      var x = Math.min(this._maxx, Math.max(this._minx, d));
    ...
    bardown: function(e) {
      ...
      var dx = (e.x - rect.left);
      var dy = (e.y - rect.top);
      var ratio = Math.sqrt(dx*dx + dy*dy) / this._w;
